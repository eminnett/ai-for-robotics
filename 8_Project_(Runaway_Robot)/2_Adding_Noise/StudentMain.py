...
def estimate_next_pos(measurement, OTHER = None):
    ...
    if OTHER == None:
        ...
        dx_s = [(measurement[0] - OTHER['previous_xs'][-1])]
        dy_s = [(measurement[1] - OTHER['previous_ys'][-1])]
        ...
        if len(OTHER['previous_xs']) > 1:
            ...
            for i in xrange(len(OTHER['previous_xs']) - 1):
                dx_s.append((OTHER['previous_xs'][-i] - OTHER['previous_xs'][-i-1]))
                dy_s.append((OTHER['previous_ys'][-i] - OTHER['previous_ys'][-i-1]))
        ...
        print "Params: ", avg_dist, alpha, avg_theta

        angle = alpha + avg_theta

        xy_estimate = (measurement[0] + avg_dist * cos(angle), measurement[1] + avg_dist * sin(angle))
