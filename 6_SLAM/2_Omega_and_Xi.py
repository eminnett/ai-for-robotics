...
def doit(initial_pos, move1, move2):
    ...
    Xi.zero(3,1)
    # Initial Position
    Omega = Omega + matrix([[1.,0.,0.],[0.,0.,0.],[0.,0.,0.]])
    Xi = Xi + matrix([[initial_pos],[0.],[0.]])
    # First move
    Omega = Omega + matrix([[1.,-1.,0.],[-1.,1.,0.],[0.,0.,0.]])
    Xi = Xi + matrix([[-move1],[move1],[0.]])
    # Second move
    Omega = Omega + matrix([[0.,0.,0.],[0.,1.,-1.],[0.,-1.,1.]])
    Xi = Xi + matrix([[0.],[-move2],[move2]])
