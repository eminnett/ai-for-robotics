...
def slam(data, N, num_landmarks, motion_noise, measurement_noise):
    ...
    #     for axis in range(2):
    #         if n == 0:
    #             Omega.value[n+axis][n+axis] += 1.
    #             Xi.value[n+axis][0] += movement[axis]
    #         else:
    #             for L in landmarks:
    #                 li = (N + L[0]) * 2
    #                 measurement = L[axis+1]
    #                 Omega.value[n+axis ][n+axis ] += 1. / measurement_noise
    #                 Omega.value[n+axis ][li+axis] += -1. / measurement_noise
    #                 Omega.value[li+axis][n+axis ] += -1. / measurement_noise
    #                 Omega.value[li+axis][li+axis] += 1. / measurement_noise
    #
    #                 Xi.value[n+axis ][0] += -measurement / measurement_noise
    #                 Xi.value[li+axis][0] += measurement / measurement_noise
    #
    #             Omega.value[n-2+axis][n-2+axis] += 1. / motion_noise
    #             Omega.value[n-2+axis][n+axis  ] += -1. / motion_noise
    #             Omega.value[n+axis  ][n-2+axis] += -1. / motion_noise
    #             Omega.value[n+axis  ][n+axis  ] += 1. / motion_noise
    #
    #             Xi.value[n-2+axis][0] += -movement[axis] / motion_noise
    #             Xi.value[n+axis  ][0] += movement[axis] / motion_noise
